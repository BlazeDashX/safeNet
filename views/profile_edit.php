  ...
  <div class="container">
    ...
    <form id="editForm" class="card" novalidate>
      ...
      <div class="form-group">
          ...
          <span id="err-name" class="error-text">Name cannot be empty</span>
      </div>
      
      <div class="form-group">
          <label>Email</label>
          <input type="email" id="editEmail" placeholder="Email" />
          <span id="err-email" class="error-text">Invalid email address</span>
      </div>

      <div class="form-group">
          <label>Date of Birth</label>
          <input type="date" id="editDob" />
          <span id="err-dob" class="error-text">You must be at least 14 years old</span>
      </div>
