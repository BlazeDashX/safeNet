            ...
            <div id="step-1">
                ...
                <form id="verifyForm">
                    <div class="form-group">
                        ...
                        <small id="error-username" class="error-msg"></small> <!-- Error -->
                    </div>
                    <div class="form-group">
                        <label for="email">Email Address</label>
                        <input type="text" id="email" name="email" placeholder="Enter your registered email">
                        <small id="error-email" class="error-msg"></small> <!-- Error -->
                    </div>
