...
// 1. Security Check: STRICTLY for Consultants
...
<body class="admin-body">
    ...
    <nav class="sidebar">
        <div class="sidebar-header">
            <h3>SAFENET</h3>
            <span class="role-badge" style="background-color: #2ecc71;">CONSULTANT</span>
        </div>
        <ul class="nav-links">
    ...
    <main class="main-content">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3>Pending Cases</h3>
                    <p class="stat-number"><?php echo $pendingRes['count']; ?></p>
                </div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    ...
                    <p class="stat-number"><?php echo $resolvedRes['count']; ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="welcome-banner" style="margin-top: 30px; background: white; padding: 30px; border-radius: 12px; border: 1px solid #e1e8ed;">
            ...
            <p style="color: #7f8c8d; margin-top: 10px;">
                ...
                <strong>Pending Cases</strong> to assist users who have reported incidents.
            </p>
        </div>
