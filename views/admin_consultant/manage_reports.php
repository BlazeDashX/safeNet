...
// Security Check: Allow Admin AND Consultant
...
$dashboardLink = ($_SESSION['type'] == 'consultant') ? 'consultantDashboard.php' : 'adminDashboard.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="admin-body">
    ...
    <nav class="sidebar">
        <div class="sidebar-header">
            <h3>SAFENET</h3>
            <span class="role-badge" style="<?php echo ($_SESSION['type'] == 'consultant') ? 'background-color:#2ecc71;' : ''; ?>">
                <?php echo strtoupper($_SESSION['type']); ?>
            </span>
        </div>
        <ul class="nav-links">
            <li><a href="<?php echo $dashboardLink; ?>"><i class="fa-solid fa-gauge"></i> Dashboard</a></li>
                ...
                <div class="report-card">
                    <div class="card-image">
                        <?php if(!empty($row['evidence'])): ?>
                            <img src="../../<?php echo $row['evidence']; ?>" onclick="window.open(this.src)" alt="Evidence" class="evidence-img">
                        <?php else: ?>
                            <div class="no-image-placeholder">No Evidence Uploaded</div>
                        <?php endif; ?>
                        
                        <span class="category-tag"><?php echo isset($row['type']) ? htmlspecialchars($row['type']) : 'Cyberbullying'; ?></span>
                    </div>
                    ...
                    <div class="card-content">
                        ...
                        <div class="description-container">
                            ...
                            echo (strlen($fullDesc) > 60) ? substr($fullDesc, 0, 60) . '...' : $fullDesc; 
                            ?>
                        ...
                        <dialog id="modal_<?php echo $row['id']; ?>" class="modal">
                            ...
                            <button onclick="this.closest('dialog').close()" class="modal-btn-close">Close</button>
                        </dialog>
